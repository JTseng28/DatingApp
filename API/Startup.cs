...
namespace API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DataContext>(options => //options is a parameter passing a statement block inside the curly brackets
            {
        ...
        {
            if (env.IsDevelopment()) //GET request to browser checking if we are in dev mode
            {
                app.UseDeveloperExceptionPage(); //using dev exception if yes to above
                app.UseSwagger();
